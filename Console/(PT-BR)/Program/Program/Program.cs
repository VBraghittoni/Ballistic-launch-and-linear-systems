    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            else
            {
                ...
                while (true)
                {
                    Console.WriteLine("Digite o valor da distância horizontal do alvo (X) em metros: ");
                    try
                    {
                ...
                while (true)
                {
                    Console.WriteLine("Digite o valor da distância vertical do alvo (H) em metros: ");
                    try
                    {
