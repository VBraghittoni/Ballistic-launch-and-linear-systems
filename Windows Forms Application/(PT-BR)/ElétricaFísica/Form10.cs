...
{
    public partial class SistemaL5 : Form
    {
        ...
        private void SistemaL5_Load(object sender, EventArgs e)
        {
            ...
            instrucoes.Text = "Digite nas quatro colunas de caixa de texto da esquerda todas as variáveis e na única coluna da direita somente os resultados:" +
                "\r\n\r\n\r\n\r\n                           x1  +                          x2  +                          x3  +                          x4   =" +
                "\r\n\r\n                           x1  +                          x2  +                          x3  +                          x4   =" +
                "\r\n\r\n                           x1  +                          x2  +                          x3  +                          x4   =" +
                "\r\n\r\n                           x1  +                          x2  +                          x3  +                          x4   =";
...

        {
            ...
            if (verifica(variavel1.Text) && verifica(variavel2.Text) && verifica(variavel3.Text) && verifica(variavel4.Text) && verifica(variavel5.Text) && verifica(variavel6.Text) && verifica(variavel7.Text) &&
                verifica(variavel8.Text) && verifica(variavel9.Text) && verifica(variavel10.Text) && verifica(variavel11.Text) && verifica(variavel12.Text) && verifica(variavel13.Text) && verifica(variavel14.Text) &&
                verifica(variavel15.Text) && verifica(variavel16.Text) && verifica(resultado1.Text) && verifica(resultado2.Text) && verifica(resultado3.Text) && verifica(resultado4.Text))
            {
                // Convertendo string para número e já fornecendo dentro do sistema:
                double[,] sistema = new double[4, 5];
                ...
                sistema[0, 3] = Convert.ToDouble(variavel4.Text);
                sistema[0, 4] = Convert.ToDouble(resultado1.Text);
                sistema[1, 0] = Convert.ToDouble(variavel5.Text);
                sistema[1, 1] = Convert.ToDouble(variavel6.Text);
                sistema[1, 2] = Convert.ToDouble(variavel7.Text);
                sistema[1, 3] = Convert.ToDouble(variavel8.Text);
                sistema[1, 4] = Convert.ToDouble(resultado2.Text);
                sistema[2, 0] = Convert.ToDouble(variavel9.Text);
                sistema[2, 1] = Convert.ToDouble(variavel10.Text);
                sistema[2, 2] = Convert.ToDouble(variavel11.Text);
                sistema[2, 3] = Convert.ToDouble(variavel12.Text);
                sistema[2, 4] = Convert.ToDouble(resultado3.Text);
                sistema[3, 0] = Convert.ToDouble(variavel13.Text);
                sistema[3, 1] = Convert.ToDouble(variavel14.Text);
                sistema[3, 2] = Convert.ToDouble(variavel15.Text);
                sistema[3, 3] = Convert.ToDouble(variavel16.Text);
                sistema[3, 4] = Convert.ToDouble(resultado4.Text);
                ...
                string resposta = sistema[0, 4].ToString();
                string resposta2 = sistema[1, 4].ToString();
                string resposta3 = sistema[2, 4].ToString();
                string resposta4 = sistema[3, 4].ToString();
        ...
        private void variavel10_KeyPress(object sender, KeyPressEventArgs e)
        {
            excecoes(variavel10.Text, e);
        }

        private void variavel11_KeyPress(object sender, KeyPressEventArgs e)
        {
            excecoes(variavel11.Text, e);
        }

        private void variavel12_KeyPress(object sender, KeyPressEventArgs e)
        {
            excecoes(variavel12.Text, e);
        }

        private void variavel13_KeyPress(object sender, KeyPressEventArgs e)
        {
            excecoes(variavel13.Text, e);
        }

        private void variavel14_KeyPress(object sender, KeyPressEventArgs e)
        {
            excecoes(variavel14.Text, e);
        }

        private void variavel15_KeyPress(object sender, KeyPressEventArgs e)
        {
            excecoes(variavel15.Text, e);
        }

        private void variavel16_KeyPress(object sender, KeyPressEventArgs e)
        {
            excecoes(variavel16.Text, e);
        }
        ...
        private void resultado4_KeyPress(object sender, KeyPressEventArgs e)
        {
            excecoes(resultado4.Text, e);
        }
    }
}
